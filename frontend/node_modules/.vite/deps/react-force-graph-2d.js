...
function L(n2, l2, u2, t3, i2, r2, o2, e2, f2, c5, a3) {
  var s2, h2, p2, v2, y3, _2, g2 = t3 && t3.__k || w, m3 = l2.length;
  for (f2 = T(u2, l2, g2, f2, m3), s2 = 0; s2 < m3; s2++) null != (p2 = u2.__k[s2]) && (h2 = -1 != p2.__i && g2[p2.__i] || d, p2.__i = s2, _2 = q(n2, p2, h2, i2, r2, o2, e2, f2, c5, a3), v2 = p2.__e, p2.ref && h2.ref != p2.ref && (h2.ref && J(h2.ref, null, p2), a3.push(p2.ref, p2.__c || v2, p2)), null == y3 && null != v2 && (y3 = v2), 4 & p2.__u ? (f2 = j(p2, f2, n2), h2.__e && (h2.__e = null)) : "function" == typeof p2.type && void 0 !== _2 ? f2 = _2 : v2 && (f2 = v2.nextSibling), p2.__u &= -7);
  return u2.__e = y3, f2;
}
...
function j(n2, l2, u2) {
  ...
  if ("function" == typeof n2.type) {
    for (t3 = n2.__k, i2 = 0; t3 && i2 < t3.length; i2++) t3[i2] && (t3[i2].__ = n2, l2 = j(t3[i2], l2, u2));
    return l2;
  }
...
function q(n2, u2, t3, i2, r2, o2, e2, f2, c5, a3) {
  ...
  n: if ("function" == typeof F) {
    ...
    try {
      ...
      if (p2.context = P2, p2.props = x3, p2.__P = n2, p2.__e = false, A2 = l.__r, H2 = 0, M) p2.state = p2.__s, p2.__d = false, A2 && A2(u2), s2 = p2.render(p2.props, p2.state, p2.context), w.push.apply(p2.__h, p2._sb), p2._sb = [];
      else do {
        p2.__d = false, A2 && A2(u2), s2 = p2.render(p2.props, p2.state, p2.context), p2.state = p2.__s;
      } while (p2.__d && ++H2 < 25);
      p2.state = p2.__s, null != p2.getChildContext && (i2 = m(m({}, i2), p2.getChildContext())), M && !v2 && null != p2.getSnapshotBeforeUpdate && (_2 = p2.getSnapshotBeforeUpdate(y3, d2)), T2 = null != s2 && s2.type === S && null == s2.key ? E(s2.props.children) : s2, f2 = L(n2, g(T2) ? T2 : [T2], u2, t3, i2, r2, o2, e2, f2, c5, a3), p2.base = u2.__e, u2.__u &= -161, p2.__h.length && e2.push(p2), k2 && (p2.__E = p2.__ = null);
    } catch (n3) {
